...
async function getData(infoWindow) {
    fetch(defaultPath + "/maps.json")
        ...
        .then((data) => {
            ...
            filterWrapper.appendChild(sliderContainer);
            sliderContainer.appendChild(filterDiv);
            ...
            playerLocation(
                data[0]["player"].iconPath,
                data[0]["player"].iconSize
            );
